    ...
    return (
        <div className="form-signin mt-5">
            <form onSubmit={handleSubmit}>
                <h1 className="text-center h3 mb-3 fw-normal">{newUser ? 'Create an account' : 'Signin'}</h1>
                {
                    newUser &&
                    <>
                ...
                <button className="w-100 btn btn-lg btn-outline-primary mb-2" type="submit">{newUser ? 'Create an account' : 'Signin'}</button>
                ...
                <p>Or</p>
                <hr />
                <button onClick={handleGoogleSignIn} className="w-100 btn btn-lg btn-outline-primary mb-2" type="submit">Connect with Google</button>
